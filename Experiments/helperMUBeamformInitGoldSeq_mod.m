function xRef = helperMUBeamformInitGoldSeq_mod
...
%% Use BPSK
goldSequence1 = (2*goldSequence1-1)*exp(1j*pi/4);
goldSequence2 = (2*goldSequence2-1)*exp(1j*pi/4);
goldSequence3 = (2*goldSequence3-1)*exp(1j*pi/4);
goldSequence4 = (2*goldSequence4-1)*exp(1j*pi/4);
goldSequence5 = (2*goldSequence5-1)*exp(1j*pi/4);
goldSequence6 = (2*goldSequence6-1)*exp(1j*pi/4);

%% Reference signal for cross correlation
txfilter = comm.RaisedCosineTransmitFilter;
xRef = txfilter([goldSequence1 goldSequence2 goldSequence3 goldSequence4 goldSequence5 goldSequence6; ...
